...
/**
 * Esta clase representa la ventana de registro para nuevos usuarios en el sistema.
 * Permite al usuario ingresar sus datos personales, incluyendo nombre de usuario, DNI, correo electrónico y fecha de nacimiento.
...
public class VRegistro1 extends JDialog implements ActionListener {
	...
	public VRegistro1(Dao dao) {
		setIconImage(Toolkit.getDefaultToolkit().getImage(VRegistro1.class.getResource("/img/logoapp.png")));
		setTitle("Registro");
		this.dao = dao;
     ...
     * @return true si el usuario tiene 18 años o más, false de lo contrario.
     */
    ...
    /**
     * Valida el formato del DNI español y verifica que el número y la letra sean coherentes.
    ...
    /**
     * Regresa a la ventana de inicio del sistema.
     */
